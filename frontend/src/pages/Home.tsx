    ...
    <div className="max-w-4xl mx-auto">
      ...
      >
        <h1 className="text-5xl font-bold text-gray-800 mb-6">
          Welcome to{' '}
          <span className="text-primary-600">Sudoku Solver</span>
        </h1>
      ...
      >
        ...
        <div className="grid md:grid-cols-3 gap-6">
          <div className="text-center">
            ...
            <h4 className="font-semibold text-gray-800 mb-2">Fast Solving</h4>
            <p className="text-sm text-gray-600">Lightning-fast backtracking algorithm</p>
          </div>
          ...
          <div className="text-center">
            ...
            <h4 className="font-semibold text-gray-800 mb-2">Smart Validation</h4>
            <p className="text-sm text-gray-600">Real-time input validation with visual feedback</p>
          </div>
